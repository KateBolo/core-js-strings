...
function countVowels(str) {
  ...
  return str && vowels ? vowels.length : 0;
}
...
function isPalindrome(str) {
  const lowStr = str.toLowerCase().replace(/[^a-z0-9]/g, '');
...
function invertCase(str) {
  return str.replace(/[a-zA-Z]/g, (lett) => {
...
function encodeToRot13(str) {
  return str.replace(
    ...
    (ind) =>
      'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm'[
        'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'.indexOf(ind)
      ]
  );
}
